...
1. ГРАМАЖЪТ Е ЗАДЪЛЖИТЕЛЕН ЗА СЪВПАДЕНИЕ:
   - "Вафла 40г" ≠ "Вафла 30г" (различен грамаж = различен продукт!)
   - "Бисквити 150г" ≠ "Бисквити 100г"
   - Ако грамажът не съвпада - НЕ съпоставяй!

2. ВНИМАВАЙ ЗА ПОДОБНИ ДУМИ:
   - "Локум" ≠ "Лимонов" (това са РАЗЛИЧНИ продукти!)
   - "Бисквити" ≠ "Вафли" 
   - "Класика" ≠ "Без захар"

3. ИЗПОЛЗВАЙ САМО ЦЕНИ ОТ СПИСЪКА "ПРОДУКТИ НАМЕРЕНИ В САЙТА"
   - Това са единствените реални цени
   - НЕ измисляй цени!

4. АКО НЕ СИ 100% СИГУРЕН - ПРОПУСНИ!
   - По-добре да липсва продукт, отколкото грешна цена

ПРИМЕРИ ЗА ПРАВИЛНИ СЪВПАДЕНИЯ:
- "Био Айран 500мл" или "Айран harmonica 500мл" → #3 (500мл съвпада)
- "Тунквана вафла класика 40г" → #8 (40г + класика)
- "Вафла без захар 40г" или "Тунквана без захар 40г" → #4 (40г + без захар)
- "Вафла без добавена захар 30г" или "Хрупкава вафла 30г" → #9 (30г!)
- "Локум роза 140г" → #1 (локум + роза + 140г)
- "Оризови топчета шоколад 50г" → #5 (50г)
- "Бисквити краве масло 150г" → #2 (150г!)
- "Smiles нахут 50г" → #12 (50г)
- "Сироп липа 750мл" → #10 (750мл)
- "Пасирани домати 680г" или "Passata 680г" → #11 (680г)
- "Крема сирене 125г" → #13 (125г)
- "Козе сирене 200г" → #14 (200г)

ПРИМЕРИ ЗА ГРЕШНИ СЪВПАДЕНИЯ (НЕ ПРАВИ ТОВА!):
- "Вафла лимонов крем 30г" → #1 (Локум роза) ❌ ГРЕШНО! Лимонов ≠ Локум!
- "Вафла 30г" → #4 (Вафла без захар 40г) ❌ ГРЕШНО! 30г ≠ 40г!
- "Бисквити 100г" → #2 (Бисквити 150г) ❌ ГРЕШНО! 100г ≠ 150г!

ФОРМАТ НА ОТГОВОРА:
JSON обект с номера (1-14) като ключове и РЕАЛНИТЕ цени като стойности.
Пример: {{"3": 2.99, "8": 2.19, "1": 3.85}}
...
def extract_prices_with_fallback(page_text):
    ...
    keywords_map = {
        ...
        "Био сироп от липа": [("сироп", "липа", "750"), ("сироп", "липов", "750")],
        "Био Пасирани домати": [("пасирани", "домати", "680"), ("passata", "680"), ("домати", "пасат", "680")],
        "Smiles с нахут и морска сол": [("smiles", "нахут", "50"), ("smiles", "chickpea"), ("смайлс", "50")],
