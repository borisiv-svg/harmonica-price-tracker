"""
Harmonica Price Tracker v5.6
3 магазина: eBag, Кашон, Balev Bio Market
Двуфазен Claude анализ с подобрен JSON parsing.
"""
...
- "Хармоника Био Айран 500мл" или "Айран 500мл" → #3 "Айран harmonica (500мл)"
- "Тунквана вафла класик 40г" или "Вафла класика 40г" → #8 "Био тунквана вафла Класика (40г)"
- "Вафла без захар 40г" или "Тунквана без захар 40г" → #4 "Био Тунквана вафла без захар (40г)"
- "Вафла без добавена захар 30г" или "Хрупкава вафла 30г" → #9 "Био вафла без добавена захар (30г)"
- "Локум роза 140г" или "Turkish Delight Rose" → #1 "Био Локум роза (140г)"
- "Оризови топчета шоколад 50г" → #5 "Био Оризови топчета с черен шоколад (50г)"
- "Обикновени бисквити 150г" или "Бисквити краве масло 150г" → #2 (ВАЖНО: 150г, не друг грамаж!)
- "Smiles нахут 50г" или "Smiles chickpea" → #12
- "Сироп липа 750мл" или "Липов сироп" → #10
- "Пасирани домати 680г" или "Passata" → #11

КРИТИЧНО:
- ГРАМАЖЪТ ТРЯБВА ДА СЪВПАДА! "Бисквити 100г" НЕ Е #2 (който е 150г)
- "Вафла 40г" НЕ Е същото като "Вафла 30г" - проверявай внимателно!
...
def update_google_sheets(results):
    ...
    try:
        ...
        # Ред 1: Заглавие
        all_data.append(['HARMONICA - Ценови Тракер v5.6', '', '', '', '', '', '', '', '', '', '', ''])
...
def main():
    print("=" * 60)
    print("HARMONICA PRICE TRACKER v5.6")
    print("Двуфазен Claude анализ + подобрен JSON parsing")
