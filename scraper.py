"""
Harmonica Price Tracker v5.7
3 магазина: eBag, Кашон, Balev Bio Market
Двуфазен Claude анализ - без референтни цени във Фаза 2.
"""
...
1. Сравни имената от сайта с нашия списък - те може да са изписани различно (с/без "Био", на английски, съкратено, с марка "Harmonica/Хармоника")
2. ГРАМАЖЪТ/ОБЕМЪТ Е КРИТИЧЕН - "вафла 40г" НЕ Е същото като "вафла 30г"
3. Използвай САМО цените от "ПРОДУКТИ НАМЕРЕНИ В САЙТА" - това са реалните цени
4. Ако продукт от сайта НЕ съвпада с нищо от нашия списък - пропусни го
5. Ако не си сигурен за съвпадение - по-добре пропусни

ПРИМЕРИ ЗА СЪВПАДЕНИЯ:
- "Хармоника Био Айран 500мл" или "Айран 500мл" → #3
- "Тунквана вафла класик 40г" или "Вафла класика 40г" → #8
- "Вафла без захар 40г" или "Тунквана без захар 40г" → #4
- "Вафла без добавена захар 30г" или "Хрупкава вафла 30г" → #9
- "Локум роза 140г" или "Turkish Delight Rose" → #1
- "Оризови топчета шоколад 50г" или "Rice balls chocolate" → #5
- "Обикновени бисквити 150г" или "Бисквити краве масло 150г" → #2
- "Smiles нахут 50г" или "Smiles chickpea" → #12
- "Сироп липа 750мл" или "Липов сироп 750" → #10
- "Пасирани домати 680г" или "Passata 680" → #11
- "Крема сирене 125г" или "Cream cheese 125" → #13
- "Козе сирене 200г" или "Goat cheese 200" → #14

КРИТИЧНО:
- Връщай САМО цените от списъка "ПРОДУКТИ НАМЕРЕНИ В САЙТА"!
- ГРАМАЖЪТ ТРЯБВА ДА СЪВПАДА! "Бисквити 100г" НЕ Е #2 (който е 150г)
- "Вафла 40г" НЕ Е същото като "Вафла 30г"

ФОРМАТ НА ОТГОВОРА:
Върни САМО JSON обект с номера като ключове и РЕАЛНИТЕ цени от сайта като стойности.
...
def update_google_sheets(results):
    ...
    try:
        ...
        # Ред 1: Заглавие
        all_data.append(['HARMONICA - Ценови Тракер v5.7', '', '', '', '', '', '', '', '', '', '', ''])
...
def main():
    print("=" * 60)
    print("HARMONICA PRICE TRACKER v5.7")
    print("Двуфазен Claude анализ (без ref цени във Фаза 2)")
