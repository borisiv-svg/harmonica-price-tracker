"""
Harmonica Price Tracker v7.9
- Alias система за алтернативни имена на продукти (Кашон използва различни наименования)
- Интелигентна валутна детекция на ниво продукт
...
# Продукти, които не се продават в определени магазини (за информация)
PRODUCTS_NOT_AVAILABLE = {
    "Kashon": [8, 21],  # Био кашкавал, Био извара - не се продават в Кашон
}
...
- #16 "Сироп от плод на бъз" = "Био сироп от бъз" (750мл)
- #19 "Солети пълнозърнести" = "Био пълнозърнести солети" (60г)
- #20 "По-кисело кисело мляко" = "Био кисело пълномаслено мляко" (400г)
- #11 "Сирене краве" = "Био краве сирене" (400г)
...
def send_email_alert(alerts):
    ...
    body_lines.append("Harmonica Price Tracker v7.9")
...
def main():
    print("=" * 60)
    print("HARMONICA PRICE TRACKER v7.9")
    print("Alias система + интелигентна валутна детекция")
